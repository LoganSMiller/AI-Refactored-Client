// <auto-generated>
//   AI-Refactored: BotJumpController.cs (Ultra-Platinum++ Overlay/Event Edition – June 2025, Overlay-Only Blueprint)
//   Overlay-only, squad/panic/suppression/anticipation-aware, pooled, headless/client parity.
//   No tick-move, transform, or teleport. All logic is overlay/event, bulletproof, and pooled.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Movement
{
    ...
    /// Overlay/event-driven only. Never sets transform or animates directly.
    /// Bulletproof: anticipation, panic, suppression, cooldowns, pooling, error-guarded. Headless/client parity.
    /// </summary>
    public sealed class BotJumpController
    {
        ...
        /// <summary>
        /// Overlay-only tick, called by BotBrain. Schedules and overlays jump/vault if permitted.
        /// </summary>
        public void Tick(float deltaTime)
        {
            try
            {
                ...
                // Overlay: If we have a queued jump target, execute jump overlay now.
                if (_hasJumpTarget)
                {
                ...
                try
                {
                    ...
                    {
                        // Occasionally hesitate/mistake for realism (overlay only)
        ...
        /// <summary>
        /// Overlays jump/vault via context. No movement is set, only animation/overlay.
        /// </summary>
        private void OverlayJump(Vector3 target, float deltaTime)
        {
            try
            {
                ...
                _context.OnJump(); // Native overlay/animation event
                _lastJumpTime = Time.time;
                _hasRecentlyJumped = true;

                // Optional: can trigger voice/pose/anticipation overlays here
                // No direct position/velocity assignment
            }
            catch (Exception ex)
            {
