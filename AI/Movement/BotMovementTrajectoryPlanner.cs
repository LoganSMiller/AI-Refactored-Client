// <auto-generated>
//   AI-Refactored: BotMovementTrajectoryPlanner.cs (Final Overlay/Event Edition – June 2025)
//   Human-squad movement flow: anticipation, chaos, inertia, role offset, avoidance, cover adaptation, zero allocations.
//   Overlay-only: outputs single normalized vector, never issues a move or sets position directly.
//   MIT License.
// </auto-generated>
    ...
    public sealed class BotMovementTrajectoryPlanner
    {
        ...
        public Vector3 ModifyTrajectory(Vector3 targetDir, float deltaTime)
        {
            try
            {
                ...
                // Organic chaos/jitter layer (personality- and context-driven)
                ...
                // Human anticipation/overshoot (micro hesitation, fake start, etc) – overlay only, does not move
                TryAnticipation(baseDir, now, ref adjusted);

                // Squad path formation overlay
                ...
                // Dynamic repulsion/avoidance from squadmates (anti-clump, anti-collision)
                ...
                // Role-based lateral/positional bias in squad (leaders, flanks)
                ...
                // Adapt to cover: bias along cover walls, maintain alignment
                ...
                // Add movement inertia: bias by current velocity (prevents robot-like starts/stops)
                ...
                // Suppression/panic: inject extra chaos
                ...
                // Universal micro-jitter (all bots, all states)
                adjusted += UnityEngine.Random.insideUnitSphere * JitterMicro;
                adjusted.y = 0f;

                // If movement blocked (stuck), add strong wobble to break out
                if (_bot.Mover?.Blocked ?? false)
                    adjusted += UnityEngine.Random.insideUnitSphere * StuckWobbleMagnitude;

                // Final sanitize and normalize: always return valid, normalized vector
