// <auto-generated>
//   AI-Refactored: FlankPositionPlanner.cs (Ultra-Platinum++ Overlay/Intent-Only Realism Edition, June 2025)
//   All logic is squad-safe, personality-aware, anti-cluster, with full micro-randomness and error-guarding.
//   Never issues moves or sets positions. Outputs only intent points for overlays.
//   No hot-path allocation. Headless/multiplayer safe. Bulletproof error isolation.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Movement
{
    ...
    /// <summary>
    /// Calculates human-like flank *positions* only (never issues movement).
    /// Intent overlay for squad-safe, personality-driven, anti-cluster side bias.
    /// </summary>
    public static class FlankPositionPlanner
    {
        ...
        /// <summary>
        /// Returns a valid flank point (never moves bot).
        /// Squad-safe, personality-aware, intent overlay only.
        /// </summary>
        ...
        /// <summary>
        /// Uses enemy forward/angle to bias a preferred side, returns intent point only.
        /// </summary>
        ...
        /// <summary>
        /// Returns a random, squad-safe fallback flank point (never moves bot).
        /// </summary>
        ...
        /// <summary>
        /// Attempts to find a valid flank point on a side with micro-random overlay.
        /// Never issues a move—returns only intent target.
        /// </summary>
            ...
            for (int i = 0; i < MaxAttemptsPerSide; i++)
            {
                ...
                if (IsValidFlankPoint(candidate, origin, out Vector3 valid, squad))
                {
                    if (UnityEngine.Random.value < MissChance && i < MaxAttemptsPerSide - 1)
                        continue; // simulate human miss/error
        ...
        /// <summary>
        /// NavMesh-validates, anti-cluster checks, never issues movement—returns only a safe overlay point.
        /// </summary>
