// <auto-generated>
//   AI-Refactored: BotMissionController.cs (Ultimate Overlay/Event, BotBrain-Only, Beyond Diamond June 2025)
//   Bulletproof: All mission/objective/squad/extraction logic is null-guarded, overlay/event-ticked, and squad-aligned.
//   No per-module tick, no side-effects, overlay/event-driven only. All failures locally isolated. MIT License.
// </auto-generated>
    ...
    public sealed class BotMissionController
    {
        ...
        public BotMissionController(BotOwner bot, BotComponentCache cache)
        {
            try
            {
                ...
                var profile = cache.AIRefactoredBotOwner?.PersonalityProfile ?? new BotPersonalityProfile();
