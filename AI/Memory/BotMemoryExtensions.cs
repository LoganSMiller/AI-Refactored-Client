...
//   Every method validates targets, never teleports, and routes all movement through BotMovementHelper with dedupe/cooldown/arbitration.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Memory
{
    ...
    /// Bulletproof: All moves are NavMesh-validated, pooled, intent-queued, event-only, arbitration-guarded, and error-shielded.
    /// </summary>
    public static class BotMemoryExtensions
    {
        ...
        /// <summary>
        /// Moves bot to fallback position, arbitration/event overlay only, full NavMesh validation and dedupe.
        /// </summary>
        public static void FallbackTo(this BotOwner bot, Vector3 fallbackPosition)
        {
            try
            {
                ...
                if (!BotOverlayManager.CanIssueMove(bot, BotOverlayType.Fallback))
                    return;
        ...
        /// <summary>
        /// Forces bot move to position, overlay/event/intent only, full NavMesh validation and arbitration.
        /// </summary>
        public static void ForceMoveTo(this BotOwner bot, Vector3 position)
        {
            try
            {
                ...
                if (!BotOverlayManager.CanIssueMove(bot, BotOverlayType.Special))
                    return;
        ...
        /// <summary>
        /// Forces cover reevaluation and retreat overlay (event-driven, arbitration/intent only).
        /// </summary>
        public static void ReevaluateCurrentCover(this BotOwner bot)
        {
            try
            {
                ...
                if (!BotOverlayManager.CanIssueMove(bot, BotOverlayType.Cover))
                    return;
        ...
        public static void SetLastHeardSound(this BotOwner bot, Player source)
        {
            try
            {
                ...
                if (!BotOverlayManager.CanIssueMove(bot, BotOverlayType.Investigate))
                    return;
