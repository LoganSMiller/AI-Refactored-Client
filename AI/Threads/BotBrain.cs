// <auto-generated>
//   AI-Refactored: BotBrain.cs (Ultra-Platinum++ Supreme Overlay Arbitration, June 2025)
//   Bulletproof, anticipation/intent/event-driven, all overlays centralized, no per-tick move, no direct transform/teleport ever.
//   SPT/FIKA/headless/client parity, max error isolation, subsystem orchestration, all pooling/zero alloc in hot path. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Threads
{
    ...
    /// <summary>
    /// Centralized AIRefactored intent dispatcher for all bot overlays. 
    /// Never performs direct per-tick movement or transform. All subsystems event/overlay-only, fully pooled.
    /// Max realism, anticipation, zero alloc in hot path, SPT/FIKA/headless/client parity. 
    /// Bulletproof: All failures are locally contained, never propagate or disable global AI.
    /// </summary>
    public sealed class BotBrain : MonoBehaviour
    {
        ...
        // Intent/event-only subsystems, arbitration-controlled
        ...
        /// Never spawns per-tick movement. Bulletproof: every failure is locally isolated.
        /// </summary>
        public void Initialize(BotOwner bot)
        {
            ...
            // Overlay/event-only: zero direct movement/position/teleport.
