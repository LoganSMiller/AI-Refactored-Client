// <auto-generated>
//   AI-Refactored: BotBrain.cs (Ultra-Platinum++ Intent Centralized, June 2025)
//   Bulletproof, anticipation/intent/event-driven, all movement overlays route via centralized dispatcher. Headless/client parity. Ultra-realism, error isolation, pooled, zero allocations in hot path. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Threads
{
    ...
    /// <summary>
    /// Centralized bot intent/overlay dispatcher. Bulletproof, anticipation/event-driven, zero direct movement, all overlays only.
    /// No per-tick movement; all intent logic and overlays routed through helpers for anti-teleport, anti-skate, anti-stutter. Strict parity.
    /// </summary>
    public sealed class BotBrain : MonoBehaviour
    {
        ...
        /// <summary>
        /// Initializes all overlay/event-only bot AI subsystems.
        /// </summary>
        ...
        /// <summary>
        /// Called once per frame by central dispatcher. Ticks only overlay/event subsystems—never per-tick movement.
        /// </summary>
        public void Tick(float deltaTime)
        {
            ...
            // --- Process scheduled/anticipated actions (all overlays/event-only movement) ---
        ...
        #region Scheduled/Anticipation Logic
