// <auto-generated>
//   AI-Refactored: BotNavHelper.cs (Overlay/Event-Only, Zero-Move, Beyond Diamond, June 2025)
//   Overlay/event-only: exposes EFT-internal nav/path state for overlays/intents. Never issues or modifies movement.
//   All outputs are overlays or pooled vectors only. Zero-allocation, multiplayer/headless parity, MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Navigation
{
    ...
    public static class BotNavHelper
    {
        ...
        /// <summary>
        /// Attempts to get a NavMesh-valid current target point for overlays (never sets position).
        /// </summary>
        ...
        /// <summary>
        /// Returns all current path points for overlay logic (never sets position).
        /// </summary>
        ...
        /// <summary>
        /// Attempts to get a jittered current path corner (overlay only).
        /// </summary>
        ...
        /// <summary>
        /// Returns the remaining distance along the current path, or float.MaxValue if invalid.
        /// </summary>
        ...
        /// <summary>
        /// Returns current destination (overlay-only, never sets position).
        /// </summary>
        ...
        /// <summary>
        /// Returns overlay nav state (never sets/changes nav, overlay-only).
        /// </summary>
        ...
        /// <summary>
        /// True if bot is at destination (overlay check).
        /// </summary>
        ...
        /// <summary>
        /// Samples candidate as a NavMesh-safe overlay point. Never issues move.
        /// </summary>
        ...
        /// <summary>
        /// Returns a NavMesh-safe overlay point or origin if invalid (never issues move).
        /// </summary>
        ...
        /// <summary>
        /// Clamps Y of overlay point to safe height.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if point is plausible for overlay use.
        /// </summary>
        ...
        /// <summary>
        /// Returns overlay target for group formation (never sets position).
        /// </summary>
        ...
        /// <summary>
        /// Returns true if a closed door blocks the line for overlays (never moves).
        /// </summary>
        ...
        /// <summary>
        /// Overlay: true if NavMesh/point is plausible for overlay intent.
        /// </summary>
        ...
        /// <summary>
        /// Overlay/event-only: navigation state enum.
        /// </summary>
