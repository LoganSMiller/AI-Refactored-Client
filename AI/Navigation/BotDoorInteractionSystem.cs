...
//   Overlay/event-driven only. Never blocks pathfinding or issues move stops.
//   All door checks are anticipation/overlay intent only—never tick-move or pause. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Navigation
{
    ...
    /// <summary>
    /// Overlay-only: handles door interactions as events/intents.
    /// Never blocks, halts, or disables bot movement or squad flow.
    /// Bulletproof, humanized, pooled, multiplayer/headless safe.
    /// </summary>
    public sealed class BotDoorInteractionSystem
    {
        ...
        /// <summary>
        /// Ticked by BotBrain. Issues overlay door interactions as intent-only events.
        /// Never blocks movement or sets forced state. Overlay/event-only.
        /// </summary>
        public void Tick(float time)
        {
            try
            {
                ...
                // Give-up period: only overlays blocked state, never disables
                ...
                // Overlay/event: Only issue interaction intent (never disables, blocks, or pauses)
                try
                {
                    EInteractionType interactionType = GetBestInteractionType(state);
                    // Overlay-only: issue door interaction intent, never blocks or disables movement.
