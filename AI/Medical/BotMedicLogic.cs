// <auto-generated>
//   AI-Refactored: BotMedicLogic.cs (Ultra-Platinum++, Beyond Diamond, BotBrain Edition, June 2025)
...
namespace AIRefactored.AI.Medical
{
    ...
    /// Ultra-Platinum++: All logic is anticipation/intent layered, error-bulletproof, squad-first, fully multiplayer/headless-safe.
    /// </summary>
    public sealed class BotMedicLogic
    {
        ...
        public void Tick(float time)
        {
            ...
            try
            {
                // Cancel healing if panicking or bot owner invalid (Layer 1: intent filter)
                if (!EFTPlayerUtil.IsValidBotOwner(_bot) || (_cache.PanicHandler != null && _cache.PanicHandler.IsPanicking))
                    return;

                // No heal if currently healing someone (Layer 2: anti-spam)
                ...
                // Squad-first: attempt squadmate heal, only fallback to self if nobody needs help (Layer 3: squad-first logic)
        ...
        /// <summary>
        /// Attempts to heal a squadmate within range who needs aid (Layer 4: squad-first, intent-guarded).
        /// </summary>
        private bool TryHealSquadmate(float time)
        {
            try
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    // Realistic healing: Only heal if wounded (optional: could check actual health here)
        ...
        /// <summary>
        /// Attempts self-healing using available medkits, surgical kits, or stimulators (Layer 5: fallback).
        /// </summary>
        ...
        /// <summary>
        /// Called when this bot is asked to heal another player (Layer 6: comms).
        /// </summary>
