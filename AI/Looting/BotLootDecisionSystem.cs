// <auto-generated>
//   AI-Refactored: BotLootDecisionSystem.cs (Ultra-Platinum++, Supreme Arbitration Overlay Edition, June 2025)
//   All logic is zero-alloc, pooled, bulletproof, squad/greed/personality-aware, multiplayer/headless/client safe.
//   Arbitration/overlay-guarded: never issues more than one loot intent per overlay/event.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Looting
{
    ...
    /// <summary>
    /// Arbitration-driven, squad-aware, greed/personality-influenced looting logic.
    /// Full overlay/intent arbitration, pooled, deduped, bulletproof, SPT/FIKA/headless safe.
    /// Never tick-moves or double-issues. 
    /// </summary>
    public sealed class BotLootDecisionSystem
    {
        ...
        /// <summary>
        /// Initializes the loot decision system for this bot.
        /// </summary>
        ...
        /// <summary>
        /// Ticks claim and loot memory. Call once per BotBrain tick.
        /// </summary>
        ...
        /// <summary>
        /// Arbitration: Returns true if the bot should attempt looting now.
        /// Only allows one overlay/event per loot, bulletproof and deduped.
        /// </summary>
        public bool ShouldLootNow()
        {
            ...
            // Overlay arbitration: Only allow if loot overlay is granted and not held by another intent.
            ...
            try
            {
                ...
                // Arbitration: If intent allowed and decision positive, register loot overlay for this event only.
                if (result)
                    BotOverlayManager.RegisterMove(_bot, BotOverlayType.Loot);
        ...
        /// <summary>
        /// Returns the best loot destination, arbitration/overlay-guarded. Never raw position; always NavMesh validated before move intent.
        /// </summary>
        public Vector3 GetLootDestination()
        {
            ...
            try
            {
                ...
                {
                    Claim(bestId);
                    // Return position, arbitration-enforced: must only be moved to via overlay/intent with NavMesh validation!
                    return best;
                }
        ...
        /// <summary>
        /// Call when the loot container is successfully looted; updates memory and cooldowns, releases claim.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if this loot container was recently looted by this bot.
        /// </summary>
