// <auto-generated>
//   AI-Refactored: BotCoverHelper.cs (Ultra-Platinum++ Realism & Safety Edition, June 2025)
...
namespace AIRefactored.AI.Helpers
{
    ...
    public static class BotCoverHelper
    {
        ...
        public static void MarkUsed(Vector3 position)
        {
            ...
            {
                // Log only in debug/dev builds.
                // Plugin.LoggerInstance?.LogDebug($"[CoverMemory] MarkUsed failed: {ex}");
            }
        }
        ...
        public static void TrySetStanceFromNearbyCover(BotComponentCache cache, Vector3 position)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Plugin.LoggerInstance?.LogDebug($"[CoverStance] TrySetStance failed: {ex}");
            }
        }
