// <auto-generated>
//   AI-Refactored: BotSuppressionHelper.cs (Supreme Arbitration Overlay/Event Edition – Ultra-Final June 2025)
//   All suppression, panic, fallback, and squad propagation logic is 100% overlay/event-driven, bulletproof, and multiplayer/headless safe.
//   No invalid fields, zero speculative API, stateless, error-contained, and pooled where applicable.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Helpers
{
    ...
    /// Overlay/event only. No speculative/invalid API. No allocations in hot paths.
    /// Multiplayer/headless safe. Never issues position/move/teleport.
    /// </summary>
    public static class BotSuppressionHelper
    {
        ...
        /// <summary>
        /// Returns true if a bot should be suppressed based on vision, lighting, threat proximity, and current panic.
        /// Overlay/event only—never ticked.
        /// </summary>
        ...
        /// <summary>
        /// Applies suppression/panic effects to a bot, marks tactical danger, and propagates to squadmates.
        /// Overlay/event only; all logic is bulletproof and error-contained.
        /// </summary>
        public static void TrySuppressBot(Player player, Vector3 threatPos, IPlayer source = null, float rawDamage = 0f)
        {
            try
            {
                ...
                // Overlay/event: only issue intent, never disables or teleports
        ...
        /// No allocation in hot path. Overlay/event only.
        /// </summary>
        ...
        /// <summary>
        /// Propagates suppression to squadmates within radius, probabilistically. Overlay/event only.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the player is currently suppressed (panicking). Overlay/event only.
        /// </summary>
