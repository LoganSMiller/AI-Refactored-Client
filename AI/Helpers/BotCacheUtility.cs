// <auto-generated>
//   AI-Refactored: BotCacheUtility.cs (Ultra-Platinum++ – Maximum Realism Registry Edition, June 2025)
//   Bulletproof, network/multiplayer/headless safe registry for all bot caches and profile-linked logic.
//   Realism-driven, zero-cascade, anti-race, and error-isolated. No fallback disables. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Helpers
{
    ...
    public static class BotCacheUtility
    {
        ...
        /// <summary>
        /// Debug/dev: logs all registered bot caches and states. Only use in diagnostics.
        /// </summary>
        ...
        /// <summary>
        /// Registers a BotOwner and its component cache to the central registry. Hardened, error-isolated, and teardown-safe.
        /// Side-effects (team/mission/group) never break registry.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters a BotOwner from all registries (cache, profile, group). Teardown-safe, error-isolated.
        /// </summary>
