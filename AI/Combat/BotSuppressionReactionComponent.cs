...
//   Overlay-only, one-move, deduped, pooled, triple-guarded, anticipation lock, squad sync, bulletproof, zero alloc.
...
namespace AIRefactored.AI.Combat
{
    ...
    /// All overlays triple-guarded: arbitration, NavMesh/y, deduplication, anticipation lock. Zero alloc, pooled, SPT/FIKA/client/headless parity.
    /// </summary>
    public sealed class BotSuppressionReactionComponent
    {
        ...
        private const float AnticipationLockWindow = 1.21f; // Overlay arbitration: after suppression move, lockout for this many seconds
        ...
        /// <summary>
        /// True if suppression/fakeout overlay lock is active for arbitration.
        /// (Overlay arbitration/fakeout/anticipation logic uses this to block rival overlays.)
        /// </summary>
        public bool AnticipationLockActive
        {
            get
            {
                // Still suppressed, or within lock window after a suppression move
                return _isSuppressed || (Time.time < _anticipationLockUntil);
            }
        }
        ...
        public void Tick(float time)
        {
            ...
            try
            {
                ...
                {
                    _isSuppressed = false;
                    // On suppression end, leave the lock active for arbitration window
        ...
        public void TriggerSuppression(Vector3? source)
        {
            ...
            try
            {
                ...
                _anticipationLockUntil = now + AnticipationLockWindow; // Set arbitration/fakeout lock after any real suppression move
