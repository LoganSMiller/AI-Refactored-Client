// <auto-generated>
//   AI-Refactored: BotFireLogic.cs (Supreme Arbitration Overlay/Event, Ultra-Realism+, June 2025, Rule 1000 Compliance)
    ...
    public sealed class BotFireLogic
    {
        ...
        public void Tick(float time)
        {
            ...
            try
            {
                ...
                // Fire: true overlay burst/trigger, human variance, no cooldown/tick
                ...
                // Use personality, distance, suppression, and current state for all fire calculations
                ...
                if (weaponManager.IsWeaponReady && UnityEngine.Random.value < fireChance && !HasFriendlyInLineOfFire(aimPosition))
                {
