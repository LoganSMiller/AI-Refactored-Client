// <auto-generated>
//   AI-Refactored: BotThreatEscalationMonitor.cs (Supreme Arbitration Overlay/Event, June 2025)
//   Extreme escalation: overlay arbitration, dedup, pooled, triple-guarded, squad comms, no disables, zero teleport, max realism.
//   Bulletproof: All logic null-guarded, error logs only, never disables, SPT/FIKA/headless/client parity.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat
{
    ...
    /// <summary>
    /// Monitors, escalates, and communicates bot/squad threat. Overlay-only, deduped, anti-teleport, pooled, max realism, never disables.
    /// All overlays triple-guarded: arbitration, NavMesh/y, deduplication.
    /// </summary>
    public sealed class BotThreatEscalationMonitor
    {
        ...
        private const float EscalationOverlayMoveDedupSqr = 0.0001f;
        private const float EscalationOverlayMoveCooldown = 0.48f;
        ...
        private void EscalateBot(float time)
        {
            ...
            // Overlay arbitration (Attack): dedup/cooldown/triple-guard with BotOverlayManager.
            if (BotNavHelper.TryGetSafeTarget(_bot, out var navTarget) && IsVectorValid(navTarget))
            {
                float now = Time.time;
                // Two-argument arbitration and registration
