// <auto-generated>
//   AI-Refactored: BotLastShotTracker.cs (Supreme Arbitration Event/Overlay, Beyond Diamond, June 2025)
//   Tracks incoming/outgoing fire, squad suppression, multi-attacker memory, panic/contagion/escalation, all pooled, bulletproof, multiplayer/headless safe, and EFT-compliant.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat
{
    ...
    /// <summary>
    /// Tracks all incoming/outgoing fire, hits, multi-attacker context, squad suppression, escalation, panic, and “heat.”
    /// Integrates with panic, suppression, fallback, and squad contagion systems. Pooled, allocation-free, zero-GC, max robustness.
    /// All APIs null-guarded, SPT/FIKA/headless/client safe, never disables. No per-frame polling; event/callback only.
    /// </summary>
    public sealed class BotLastShotTracker
    {
        ...
        private AttackerRecord[] _recentAttackers = new AttackerRecord[MaxAttackersTracked];
        ...
        #region Event APIs (All event/callback only)
        ...
        /// <summary>
        /// Returns IDs of all profiles who have hit us recently.
        /// </summary>
        ...
        /// <summary>
        /// Was any attacker recently very close to the bot?
        /// </summary>
