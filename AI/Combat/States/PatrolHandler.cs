// <auto-generated>
//   AI-Refactored: PatrolHandler.cs (Ultra-Platinum++ Zero-Teleport, Max Realism Overlay Edition, June 2025, Hitch/Teleport Fix Pass)
...
namespace AIRefactored.AI.Combat.States
{
    ...
    public sealed class PatrolHandler
    {
        ...
        {
            // If patrol has just issued a move this frame, return that.
            if (_lastIssuedMove != Vector3.zero)
                return _lastIssuedMove;

            // Predict next move: pick a hotspot (using patrol logic), do not issue move.
