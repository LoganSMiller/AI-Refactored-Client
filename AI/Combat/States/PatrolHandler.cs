// <auto-generated>
//   AI-Refactored: PatrolHandler.cs (Ultra-Platinum++, Max Realism Overlay Edition, June 2025)
//   All patrol/fallback logic is overlay/event-only, NavMesh/squad/personality/cover aware, pooled, error-isolated.
//   No disables, never tick-moves or teleports, never direct transform assign. SPT/FIKA/headless/client parity.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat.States
{
    ...
    /// <summary>
    /// Handles realistic patrol and fallback—FSM/Brain only, overlay/event-driven, never disables or teleports.
    /// All patrol/fallback is NavMesh-only, squad/personality/cover aware, pooled, and error-isolated.
    /// </summary>
    public sealed class PatrolHandler
    {
        ...
        /// <summary>
        /// Overlay/event-driven patrol and fallback; called only by FSM/BotBrain, never tick-moves or disables.
        /// </summary>
