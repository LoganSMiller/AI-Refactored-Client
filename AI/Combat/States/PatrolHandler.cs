// <auto-generated>
//   AI-Refactored: PatrolHandler.cs (Supreme Arbitration Overlay/Event, Ultra-Realism+ June 2025)
//   Overlay/event-only patrol/fallback—NavMesh/squad/personality/cover aware, pooled, anti-parallel, anti-clump, error-isolated. 
...
//   No disables, no tick-move, never teleports or sets transform. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat.States
{
    ...
    public sealed class PatrolHandler
    {
        ...
        private const float MicroJitter = 0.13f;
        ...
        public void Tick(float time)
        {
            ...
            try
            {
                ...
                // Anti-parallel & anti-clump: Check squad for parallel/overlap and adjust drift if needed.
                ...
                // Subtle anti-stuck micro-jitter overlay
                if (UnityEngine.Random.value < 0.15f)
                    target += UnityEngine.Random.insideUnitSphere * MicroJitter;
        ...
        {
            var hotspot = HotspotRegistry.GetRandom();
        ...
        private bool ShouldTriggerFallback(float time)
        {
            try
            {
                ...
                if (_cache.InjurySystem != null && _cache.InjurySystem.NeedsImmediateHeal()) return true;
