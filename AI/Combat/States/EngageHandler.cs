// <auto-generated>
//   AI-Refactored: EngageHandler.cs (Supreme Arbitration Overlay/Event Edition, Ultra Realism & Safety, June 2025)
...
//   Bulletproof: pooling, zero alloc, error-isolated, SPT/FIKA/headless/client parity, perfect squad logic, cover-to-cover, tactical. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat.States
{
    ...
    /// All movement triple-guarded (arbitration, navmesh/y, dedup), anti-parallel, anti-clump, cover-to-cover.
    /// Bulletproof and pooled. Never disables. 1:1 parity SPT/FIKA/headless/client. No teleport. Max realism.
    /// </summary>
    public sealed class EngageHandler
    {
        ...
        /// <summary>
        /// Resets handler to pristine state for engagement.
        /// </summary>
        public void Clear()
        {
        ...
        public void Tick()
        {
            ...
            try
            {
                ...
                Vector3 destination = GetCoverAwareAdvanceTarget(enemyPos, distToTarget);
        ...
        private Vector3 GetCoverAwareAdvanceTarget(Vector3 baseTarget, float dist)
        {
            // If cover available, leapfrog to cover-to-cover before closing distance
            if (_cache.CoverPlanner != null && _cache.CoverPlanner.TryGetBestCoverNear(baseTarget, _bot.Position, out Vector3 cover))
            {
                Vector3 lateral = Vector3.Cross(Vector3.up, (baseTarget - cover).normalized);
                Vector3 candidate = cover + lateral * UnityEngine.Random.Range(-0.3f, 0.3f);
                return BotNavHelper.TryGetSafeTarget(_bot, out Vector3 safeCover) ? safeCover : candidate;
            }
            // Squad overlays via squad path
