// <auto-generated>
//   AI-Refactored: EngageHandler.cs (Ultra-Platinum++, Max Realism Overlay Edition, June 2025, Hitch/Teleport Fix Pass)
...
//   Overlay-move deduped, anticipation/fakeout checked, and cooldown-enforced before any move. 
//   MIT License.
// </auto-generated>
    ...
    public sealed class EngageHandler
    {
        ...
        public void Tick()
        {
            ...
            try
            {
                ...
                // Overlay anticipation/fakeout guard (do not issue/queue moves during anticipation/fakeout overlays)
                ...
                // Overlay-move dedup/cooldown/anticipation/paused/interaction check
                if (!ShouldIssueOverlayMove(safeDest, now))
                    return;
