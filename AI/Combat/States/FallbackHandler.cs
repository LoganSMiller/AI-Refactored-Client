// <auto-generated>
//   AI-Refactored: FallbackHandler.cs (Final Overlay-Only, NavMesh-Validated, June 2025)
//   NavMesh-clamped, retry-guarded, never teleports, disables, or assigns transform. Squad/cover/personality aware.
//   No tick-move, zero vanilla fallback, SPT/FIKA/headless/client parity, pooled, bulletproof.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat.States
{
    ...
    /// <summary>
    /// Handles all fallback logic—event/intent-only, NavMesh/door/personality/squad validated.
    /// Never tick-moves or disables. Always pooled, robust, and multiplayer/headless safe.
    /// </summary>
    public sealed class FallbackHandler : IDisposable
    {
        ...
        /// <summary>
        /// Main fallback logic—called by BotBrain. Only issues a move if safe, anticipated, and not yet arrived.
        /// No tick-looped movement.
        /// </summary>
        public void Tick(float deltaTime, float now, Action<CombatState, float> forceExit)
        {
            ...
            // Squad panic spread—one time only
            ...
            // Always uses deduped/cooldown-checked move helper (never tick-move spam)
