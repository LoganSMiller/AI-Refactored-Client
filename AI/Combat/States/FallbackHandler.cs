// <auto-generated>
//   AI-Refactored: FallbackHandler.cs (Ultra-Platinum++ Zero-Teleport, Max Realism Overlay, June 2025, Hitch/Teleport Fix Pass)
...
namespace AIRefactored.AI.Combat.States
{
    ...
    /// All fallback moves are overlay/event-only, no disables, teleports, direct transform, or vanilla fallback.
    ...
    public sealed class FallbackHandler : IDisposable
    {
        ...
        /// <summary>
        /// Overlay-driven fallback tick: only ever issues move via BotMovementHelper, bulletproof retry/guarded.
        /// </summary>
        public void Tick(float deltaTime, float now, Action<CombatState, float> forceExit)
        {
            ...
            // Panic spread logic (once per fallback event)
            ...
            // Always sample fallback target, retry or cancel if not valid
            ...
            {
                // ONLY here: fallback move, via SmoothMoveToSafe
