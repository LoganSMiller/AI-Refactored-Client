// <auto-generated>
//   AI-Refactored: FallbackHandler.cs (Supreme Arbitration Overlay/Event, Max Realism, June 2025)
//   Overlay/intent-only fallback. All fallback moves are NavMesh/personality/squad validated, retry-guarded, no disables, teleports, or direct transform.
//   Bulletproof: pooling, error isolation, SPT/FIKA/headless/client parity. Squad/panic/personality aware.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Combat.States
{
    ...
    /// <summary>
    /// Drives all fallback overlay/intent movement: NavMesh+personality+squad validated, retry-guarded, error-isolated.
    /// All fallback moves are overlay/event-only, never disables, teleports, direct transform, or vanilla fallback.
    /// All moves go through BotMovementHelper.SmoothMoveToSafe; bulletproof, pooled, multiplayer/headless safe.
    /// </summary>
    public sealed class FallbackHandler : IDisposable
    {
        ...
        /// <summary>
        /// Sets a fallback move intent to a NavMesh/Y/squad/personality safe overlay position.
        /// </summary>
        ...
        public void Tick(float deltaTime, float now, Action<CombatState, float> forceExit)
        {
            ...
            // Overlay arbitration: only one fallback/intent per bot per tick
            ...
            // NavMesh/Y fallback overlay revalidation; retries if invalid
            ...
            // Overlay dedup, cooldown, anticipation/paused/interaction
            if ((navSafe - _lastIssuedMove).sqrMagnitude < OverlayMoveDedupSqr &&
                (now - _lastMoveIssueTime) < MoveCooldown)
                return;
