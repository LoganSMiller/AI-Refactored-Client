// <auto-generated>
//   AI-Refactored: BotPanicHandler.cs (Ultimate Realism – June 2025, Squad-Contagion & Fallback API Edition, Hitch/Teleport Fix Pass)
//   Ultra-realistic, bulletproof panic, suppression, composure, retreat, stutter, and squad emotional sync.
//   All overlay moves deduped, guarded, and never teleported or double-issued.
...
namespace AIRefactored.AI.Combat
{
    ...
    /// All errors are locally isolated. All overlay moves are anti-hitch/anti-teleport and never double-issued.
    /// </summary>
    public sealed class BotPanicHandler
    {
        ...
        // Overlay dedup: last move issued in retreat/overlay
        ...
        private void TryStartPanic(float now, Vector3 retreatDir, bool isSquadSync)
        {
            ...
            try
            {
                ...
                // Dedup and cooldown overlay retreat/fallback moves
                ...
                // Else: do nothing, never update move cache unless move is actually issued
            }
            catch (Exception ex)
            {
