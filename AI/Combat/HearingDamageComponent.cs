// <auto-generated>
//   AI-Refactored: HearingDamageComponent.cs (Supreme Arbitration, Max Realism, June 2025)
//   Ear fatigue, nonlinear ringing, self-healing, zero allocations, bulletproof. SPT/FIKA/headless/client parity.
//   Licensed under MIT.
// </auto-generated>
    ...
    public sealed class HearingDamageComponent
    {
        ...
        public void ApplyDeafness(float intensity, float duration)
        {
            try
            {
                ...
                // Only escalate deafness if new event is stronger or duration is longer
