// <auto-generated>
//   AI-Refactored: BotPerceptionSystem.cs (Beyond Diamond, Max Realism, Overlay/Event-Only, June 2025)
...
namespace AIRefactored.AI.Perception
{
    ...
    public sealed class BotPerceptionSystem : IFlashReactiveBot
    {
        ...
        /// <summary>
        /// Overlay-only: Handles flashblindness (never tick-based).
        /// </summary>
        public void ApplyFlashBlindness(float intensity)
        {
            ...
            try
            {
                ...
                // Overlay: speech, never triggers direct pose or animation.
        ...
        /// <summary>
        /// Overlay-only: Handles suppression stimulus (never tick-based).
        /// </summary>
        ...
        /// <summary>
        /// Overlay-only: Handles direct flash exposure events (never tick-based).
        /// </summary>
        ...
        /// <summary>
        /// Overlay/event-only: Evaluates new flashlight exposure for blindness.
        /// </summary>
        ...
        /// <summary>
        /// Overlay/event-only: Recovery logic for all suppression/flash/flare factors.
        /// </summary>
        ...
        /// <summary>
        /// Overlay/event-only: Triggers panic intent if blinded/panicked, no tick logic.
        /// </summary>
        ...
        /// <summary>
        /// Overlay/event-only: Syncs enemy status across squad if visible.
        /// </summary>
