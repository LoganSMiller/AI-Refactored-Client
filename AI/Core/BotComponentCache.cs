...
//   Full overlay lock/anti-spam, arbitration, zero-alloc, movement/event safety, pooled, robust teardown, SPT/FIKA/headless/client parity.
//   All subsystem attach, lifecycle, and error handling is strictly bulletproof and locally isolated. MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Core
{
    ...
    /// <summary>
    /// Canonical runtime cache and controller for all AIRefactored bot subsystems.
    /// All arbitration/event logic, overlay/intent/pooled subsystems, and teardown are centralized and bulletproof.
    /// SPT/FIKA/headless/client full parity; zero deadlocks, always ready for reuse or teardown.
    /// </summary>
    public sealed class BotComponentCache : IDisposable
    {
        ...
        /// <summary>
        /// Initializes all AIRefactored subsystems, overlays, and arbitration/event locks.
        /// Fully pooled, bulletproof, and SPT/FIKA/headless/client parity.
        /// </summary>
        public void Initialize(BotOwner bot)
        {
            ...
            // Overlay/event-only: all critical subsystems are initialized bulletproofed.
        ...
        /// <summary>
        /// Ensures AIRefactoredBotOwner is present, or initializes and sets it.
        /// </summary>
        ...
        /// <summary>
        /// Ensures PersonalityProfile is valid and initialized for this bot.
        /// </summary>
        ...
        /// <summary>
        /// Bulletproofs all subsystem attach logic.
        /// </summary>
        ...
        #region Auditory & Event Registration

        /// <summary>
        /// Registers a heard sound for perception/event overlays.
        /// </summary>
        ...
        /// <summary>
        /// Disposes all overlay locks, event pools, and safely clears all subsystems for teardown or pooling.
        /// </summary>
        public void Dispose()
        {
            if (_disposed)
