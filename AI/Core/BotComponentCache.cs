// <auto-generated>
//   AI-Refactored: BotComponentCache.cs (Supreme Arbitration Overlay/Event Edition – June 2025, Beyond Diamond, Mastermoveplan, Max Feature, Ultra-Robust)
//   Absolute: Single init, owner wiring guards, concurrency/race safety, squad-safe overlays, error isolation, zero alloc in hot paths, SPT/FIKA/headless/client safe.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Core
{
    ...
    /// <summary>
    /// Central, pooled, arbitration/event-only, bulletproof subsystem cache for every AIRefactored bot.
    /// All subsystems are error-guarded, concurrency-safe, overlay-parity, zero-alloc in hot paths, SPT/FIKA/headless/client safe.
    /// </summary>
    public sealed class BotComponentCache : IDisposable
    {
        ...
        // Overlay/event-driven subsystems
        ...
        public BotThreatEscalationMonitor ThreatEscalation { get; private set; }
        ...
        /// <summary>
        /// True if all arbitration/event systems are initialized, not disposed, and owner is wired.
        /// </summary>
        public bool IsReady =>
            ...
            !_disposed && ThreatEscalation != null;
        ...
        /// <summary>
        /// Wires all arbitration/event-driven AI subsystems for this bot. Thread/race-safe, one-shot.
        /// </summary>
        public void Initialize(BotOwner bot)
        {
            ...
            TryInit(() => { ThreatEscalation = new BotThreatEscalationMonitor(); ThreatEscalation.Initialize(bot); }, nameof(ThreatEscalation));
        ...
        #region Owner/Personality Wiring
        ...
        /// <summary>
        /// Registers that the bot has heard a sound from a given world direction (relative).
        /// </summary>
