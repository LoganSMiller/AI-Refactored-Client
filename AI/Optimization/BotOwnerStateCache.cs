// <auto-generated>
//   AI-Refactored: BotOwnerStateCache.cs (Beyond Diamond, Stutter/Teleport-Proof, Human Realism Edition, June 2025)
//   All personality cache/shift logic is bulletproof, error-isolated, and optimized for maximum realism.
//   All movement is micro-randomized, NavMesh-validated, and 100% teleport/stutter proof. Never allocates outside pools.
//   All movement is overlay/event/cooldown driven—never tick or per-frame.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Optimization
{
    ...
    public sealed class BotOwnerStateCache
    {
        ...
        /// Follows all movement helper/cooldown standards for full realism.
        /// </summary>
        private static void TriggerZoneShift(BotOwner botOwner, bool? advance, float length, float delay)
        {
            try
            {
                ...
                // ---- Patch: Use BotMovementHelper.GetPosition (added to BotMovementHelper as utility)
                ...
                if (shift.sqrMagnitude > 0.02f)
                {
                    ...
                    // Patch: robust NavMesh sampling (no custom TryGetNavMeshSafePosition)
                    ...
                    // Movement helper guards all spam/cooldown
