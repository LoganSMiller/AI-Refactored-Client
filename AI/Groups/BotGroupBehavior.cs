// <auto-generated>
//   AI-Refactored: BotGroupBehavior.cs (Beyond Diamond Overlay/Event Edition – June 2025, Arbitration-Only Overlay Plan)
//   Ultimate realism: flocking, dynamic roles, leadership, emotion, squad comms, arbitration-only, event/overlay movement only.
//   All movement is overlay/event-only, arbitration-guarded, NavMesh safe, deduped, pooled, and bulletproof.
//   Never teleports, never disables, never allocates in hot path. Fully multiplayer/headless safe.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Groups
{
    ...
    public sealed class BotGroupBehavior
    {
        ...
        public void Tick(float deltaTime)
        {
            ...
            // Repulsion: don't stack with squadmate
            ...
            if (hasFurthest)
            {
                ...
                {
                    TryOverlayMove(
                        SafeNavMeshMove(SmoothDriftMove(myPos, dir.normalized * MaxSpacing * 0.69f, deltaTime, false), myPos));
                    IsFollowingLeader = false;
                    return;
                }
            }
            ...
            if (closestIdx >= 0 && closestDist > 0.65f && closestDist < MaxSquadRadiusSqr)
            {
                ...
                {
                    TryOverlayMove(
                        SafeNavMeshMove(SmoothDriftMove(myPos, leaderDir.normalized * (MinSpacing * 0.8f), deltaTime, false), myPos));
