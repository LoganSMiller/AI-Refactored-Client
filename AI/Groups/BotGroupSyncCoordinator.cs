// <auto-generated>
//   AI-Refactored: BotGroupSyncCoordinator.cs (Ultimate Realism – BotBrain-Driven Edition, Hitch/Teleport Fix Pass, June 2025)
//   All squad sync, fallback, danger, loot, and extraction comms are strictly BotBrain tick-driven.
//   No timers, coroutines, or async logic outside BotBrain. All errors are strictly local. Bulletproof: Never disables, never allocates in hot path, no teleports.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Groups
{
    ...
    public sealed class BotGroupSyncCoordinator
    {
        ...
        /// <summary>
        /// Shares a fallback position to the squad (never assigns position directly, never teleports).
        /// All fallback moves are NavMesh/overlay/event-only, each squadmate validates before issuing.
        /// </summary>
        public void ShareFallbackToSquad(Vector3 fallback, float now)
        {
            ...
            foreach (var mate in _teammateCaches.Values)
            {
                try
                {
                    ...
                    // Overlay/event only! No direct position set or teleportation.
        ...
        /// Triggers panic overlay/event only—no disables, teleports, or direct movement.
        /// </summary>
        ...
        /// <summary>
        /// Shares a loot position to the squad (pooled and NavMesh-validated).
        /// </summary>
        ...
        /// <summary>
        /// Shares an extract position to the squad (overlay/event only).
        /// </summary>
