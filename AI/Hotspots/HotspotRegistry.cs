...
//   Bulletproof: All logic is zero-alloc, pooled, 100% null-safe, map/zone/scenario-aware, error-isolated, and multiplayer/headless-safe.
//   MIT License.
// </auto-generated>
...
namespace AIRefactored.AI.Hotspots
{
    ...
    /// Query-safe, zone-aware, pooled, error-isolated. Bulletproof: All init/lookup/query logic is alloc-free, no cascades.
    /// Fully multiplayer/headless/squad/zone safe.
    /// </summary>
    public static class HotspotRegistry
    {
        ...
        /// <summary>
        /// Clears all hotspot data (should be called on raid end or world unload).
        /// </summary>
        ...
        /// <summary>
        /// Loads and registers all hotspots for the given mapId (init is bulletproof and repeat-safe).
        /// </summary>
        ...
        /// <summary>
        /// Returns all hotspots for the current map (read-only).
        /// </summary>
        ...
        /// <summary>
        /// Returns a random hotspot, or an empty hotspot if none loaded.
        /// </summary>
        ...
        /// <summary>
        /// Returns all hotspots within radius of position, passing the filter (must Return() the pooled list after use).
        /// </summary>
        ...
        /// <summary>
        /// Returns a random hotspot from a zone, or Hotspot.None if zone not found.
        /// </summary>
